...
- `↗ 对角2` - 反对角线移动
- `∞ 8字` - 无穷大符号轨迹
- `👁️ 眼睛模式` - 利萨如曲线，形成眼睛形状的复杂轨迹（速度0.65倍，更舒缓）
...
### v1.4.0 (2025-12-29)
- ✨ 新增「眼睛模式」- 利萨如曲线轨迹，形成眼睛形状
- ✨ 新增钟摆运动模式（上摆/下摆）
- 🎨 方向选择器改为按钮组，告别下拉菜单
- 🐛 修复眼睛模式声画同步问题
- 📱 修复移动端音频播放问题（iPhone 静音模式检测）
- 🔊 添加静音模式警告提示
- 💄 优化音频初始化体验

### v1.3.0
- 🎉 添加完整的 Landing Page（营销落地页）
- 🌍 完整的中英文双语支持
- 💰 Freemium 商业模式实现
